...
export type ChatFragmentFragment = { __typename?: 'Chat', _id: string, name: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } } | null };
...
export type CreateChatMutation = { __typename?: 'Mutation', createChat: { __typename?: 'Chat', _id: string, name: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } } | null } };
...
export type ChatQuery = { __typename?: 'Query', chat: { __typename?: 'Chat', _id: string, name: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } } | null } };
...
export type ChatsQuery = { __typename?: 'Query', chats: Array<{ __typename?: 'Chat', _id: string, name: string, latestMessage?: { __typename?: 'Message', _id: string, content: string, createAt: any, chatId: string, user: { __typename?: 'User', _id: string, email: string, username: string, imageUrl: string } } | null }> };
